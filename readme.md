...
--data-raw '{
    "email": "satriaardiperdana4@gmail.com",
    "password": "123040069",
    "name": "Satria Ardi Perdana"
  }'
```
...
--header 'Content-Type: application/json' \
--data-raw '{"email":"satriaardiperdana@gmail.com","password":"123040069"}'
```
# Logout
```
curl --location --request POST 'http://localhost:8080/api/v1/auth/logout' \
--header 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3Nzg0OTI3MjgsImp0aSI6ImM3MWZjMGJiLTAzMDMtNDY4Mi04Zjk1LTQzNWU4NzAzMDdjZSIsInVzZXJfaWQiOjF9.CU3abLSxXRVtsjQesXS4ZHHyhwFzaoZceis7BDzr3Ss'
```

# Create category
```
curl --location 'http://localhost:8080/api/v1/categories' \
--header 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3Nzg0ODExMjQsInVzZXJfaWQiOjZ9.gD3sE8ofGR-nTKH7oZWBrVeqV4H8QWVrHZQOTLVzHx0' \
--header 'Content-Type: application/json' \
--data '{
    "name": "Drink Water",
    "type": "expense"
...
```
curl --location 'http://localhost:8080/api/v1/categories' \
--header 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3Nzg0ODEyNzgsInVzZXJfaWQiOjJ9.bHc4ixv3bb26cUJiB0XNZBwbMoZQtEdvca_Hp9lVVHA'
```
# Update Category
```
curl --location --request PUT 'http://localhost:8080/api/v1/categories/13' \
--header 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3Nzg0ODg1NDMsInVzZXJfaWQiOjZ9.0x1RoWGXcwndNpe0sEx5JjdfgpNU-DslJYOyzfn81Gc' \
--header 'Content-Type: application/json' \
--data '{
...
# Delete Category
```
curl --location --request DELETE 'http://localhost:8080/api/v1/categories/13' \
--header 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3Nzg0ODg2NzgsInVzZXJfaWQiOjJ9.OvKMJVJ1iyICeM9YpMtpTelz2JpPAuK70mKsblwiog4'
```
# Create transaction
```
curl --location 'http://localhost:8080/api/v1/transactions' \
--header 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3Nzg0ODg5MTQsInVzZXJfaWQiOjJ9.6RVEbDpkiweOoeGhZMwmCRVJa5aYGUCYUhkRAawKCuY' \
--header 'Content-Type: application/json' \
--data '{
    "category_id": 5,
    "amount": 75000,
    "date": "2026-05-10",
    "note": "Makan siang Pagi Sore"
  }'
```
# Update Transactions
```
curl --location --request PUT 'http://localhost:8080/api/v1/transactions/18' \
--header 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3Nzg0OTAwOTQsInVzZXJfaWQiOjJ9.vIDRlpRXC_yf0FQ6O6jUZ9v5ahKicx5lXshOs9Bdc6U' \
--header 'Content-Type: application/json' \
--data '{
    "category_id": 5,
    "amount": 100000,
...
```
curl --location --request DELETE 'http://localhost:8080/api/v1/transactions/12' \
--header 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3Nzg0OTAwOTQsInVzZXJfaWQiOjJ9.vIDRlpRXC_yf0FQ6O6jUZ9v5ahKicx5lXshOs9Bdc6U'
```
# Main Page transaction Summary limit 10
```
curl --location 'http://localhost:8080/api/v1/reports/main-summary' \
--header 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3Nzg0OTA1OTEsInVzZXJfaWQiOjF9.IeuJoUs6VpuX_yo06AL6uzJ6GVLDncpQu3LQCPYIt7I'
```

# Report Last 7 Days
```
curl --location 'http://localhost:8080/api/v1/reports/last7days' \
--header 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3Nzg0OTI3MjgsImp0aSI6ImM3MWZjMGJiLTAzMDMtNDY4Mi04Zjk1LTQzNWU4NzAzMDdjZSIsInVzZXJfaWQiOjF9.CU3abLSxXRVtsjQesXS4ZHHyhwFzaoZceis7BDzr3Ss'
```

# Report Last 30 Days
```
curl --location 'http://localhost:8080/api/v1/reports/last30days' \
--header 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3Nzg0OTA1OTEsInVzZXJfaWQiOjF9.IeuJoUs6VpuX_yo06AL6uzJ6GVLDncpQu3LQCPYIt7I'
```

# Report Date Range
```
curl --location 'http://localhost:8080/api/v1/reports/date-range?from=2026-05-01&to=2026-05-31' \
--header 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3Nzg0OTA1OTEsInVzZXJfaWQiOjF9.IeuJoUs6VpuX_yo06AL6uzJ6GVLDncpQu3LQCPYIt7I'
```
